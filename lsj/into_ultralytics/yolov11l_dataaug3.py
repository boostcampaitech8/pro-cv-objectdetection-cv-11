...
data_yaml_path = BASE_DIR / "dataset" / "yolo_dataset3" / "trash10.yaml"

WANDB_ENTITY = "cv_11"
WANDB_PROJECT = "cv_11_OD"

PROJECT_NAME = "trash10-yolo11l-dataaug-rev3"
...
save_submission(
    ...
    stage="dataaug-rev3",
    base_dir=BASE_DIR,
    img_test_dir=BASE_DIR / "dataset" / "yolo_dataset3" / "images" / "test"
)
